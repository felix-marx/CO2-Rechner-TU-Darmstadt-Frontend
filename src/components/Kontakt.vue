 <template>
  <v-dialog v-model="dialog" width="500">
    <template v-slot:activator="{ on, attrs }">
      <v-btn class="mx-4" text v-bind="attrs" v-on="on" flat>
    ...
    <v-card>
      ...
      <v-list-item>
        <!--- Kontakt Bild --->
        <v-list-item-avatar size="150" left>
          <v-img
        ...
        <v-list-item-content>
          <v-card elevation="0">
            ...
            <a href="mailto:nachhaltigkeit@tu-darmstadt.de"
          ...
          <div class="my-2 mx-2" v-html="addresse"></div>
        </v-list-item-content>
      </v-list-item>
      <v-card-actions>
        <v-spacer></v-spacer>
