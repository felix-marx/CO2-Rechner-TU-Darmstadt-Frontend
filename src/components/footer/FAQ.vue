          ...
          >
            ...
            >
              ...
              >
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    >
                      ...
                      <p v-html="$t('footer.FAQ.Antwort_2_6_2')" />
                    </v-card>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    <b v-html="$t('footer.FAQ.Frage_2_7')" />
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <v-card
                      class="mt-4"
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    <v-card
                      ...
                      elevation="0"
                    >
                      <p> {{ $t('footer.FAQ.Antwort_2_11_1') }} </p>
                      <p> {{ $t('footer.FAQ.Antwort_2_11_2') }} </p>
                    </v-card>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    <v-card
                      ...
                      elevation="0"
                    >
                      <p> {{ $t('footer.FAQ.Antwort_3_2_1') }} </p>
                      <p> {{ $t('footer.FAQ.Antwort_3_2_2') }} </p>
                      <p> {{ $t('footer.FAQ.Antwort_3_2_3') }} </p>
                      <p> {{ $t('footer.FAQ.Antwort_3_2_4') }} </p>
                      <p> {{ $t('footer.FAQ.Antwort_3_2_5') }} </p>
                      <p> {{ $t('footer.FAQ.Antwort_3_2_6') }} </p>
                    </v-card>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    <v-card
                      ...
                      elevation="0"
                    >
                      <p> {{ $t('footer.FAQ.Antwort_4_3_1') }} </p>
                      <p> {{ $t('footer.FAQ.Antwort_4_3_2') }} </p>
                    </v-card>
                  </v-expansion-panel-content>
                </v-expansion-panel>
              </v-expansion-panels>
